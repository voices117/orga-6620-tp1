...
\begin{figure}
\begin{center}
\subfloat[]{\includegraphics[width = 2in]{img/matc.jpeg}} 
\subfloat[]{\includegraphics[width = 2in]{img/matasm.jpeg}}
\end{center}
...
\begin{figure}
\begin{center}
\subfloat[]{\includegraphics[width = 2in]{img/time1.jpeg}} \\
\subfloat[]{\includegraphics[width = 2in]{img/time2.jpeg}} \\
\subfloat[]{\includegraphics[width = 2in]{img/time3.jpeg}} 
\end{center}
